...
##### 6 Nästlad array
En nästlad array är en array som innehåller arrayer. Tänk dig en lista med användare, sjävla listan som håller alla användare kommer vara en array, men även varje användare i listan kommer vara en array. Alltså har vi en stor array med massor av arrayer inuti! Tänk dig en lista med användare, sjävla listan som håller alla användare kommer vara en array, men även varje användare i listan kommer vara en array. Alltså har vi en stor array med massor av arrayer inuti! Det kallas också för flerdimensionell array, det finns ingen direkt begränsning på hur djup (alltså antal dimensioner) den kan vara.
