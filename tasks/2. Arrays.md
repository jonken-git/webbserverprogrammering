...
##### 3.2
Fortsätt på uppgiften innan. Hitta _nyckeln_ (alltså arrayr-indexet) som hör till det största talet.
...
##### 6.3
Loopa igenom dina hobbies som du precis la till i din ```$person```-array.